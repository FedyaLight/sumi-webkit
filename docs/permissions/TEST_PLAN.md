...
| Notifications and userscripts | `SumiNotificationPermissionBridgeTests`, `UserScriptsRuntimeTests` | Website notifications and `GM_notification` use coordinator/system state and do not request macOS authorization directly. |
