...
public struct SumiPermissionRequest: Codable, Equatable, Hashable, Identifiable, Sendable {
    ...
    public let permissionTypes: [SumiPermissionType]
    ...
    public var pageBucketId: String {
        pageId ?? tabId ?? "global"
    }

    public var queuePersistentIdentity: String {
    ...
    public func key(for permissionType: SumiPermissionType) -> SumiPermissionKey {
        SumiPermissionKey(
    ...
    private static func normalizedDisplayDomain(_ value: String) -> String {
        SumiPermissionDisplayDomainFormatter.trimmedDisplayDomain(value, fallback: "Unknown Origin")
    }
}
