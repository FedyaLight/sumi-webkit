...
public enum SumiPermissionType: Codable, Hashable, Sendable {
    case camera
    case microphone
    ...
    public static func == (lhs: SumiPermissionType, rhs: SumiPermissionType) -> Bool {
    ...
    public var expandedForPersistence: [SumiPermissionType] {
        switch self {
        case .cameraAndMicrophone:
    ...
    public var isSensitivePowerful: Bool {
        switch self {
        case .camera,
             .microphone,
             .cameraAndMicrophone,
    ...
    public static func normalizedExternalScheme(_ scheme: String) -> String {
        scheme
