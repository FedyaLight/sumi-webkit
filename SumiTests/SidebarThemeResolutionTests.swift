...
final class SidebarThemeResolutionTests: XCTestCase {
    ...
    func testWebsiteChromeSurfacesUseResolvedTokensAndZenGeometry() throws {
        ...
        XCTAssertFalse(websiteSource.contains(".background(contentSurfaceBackground)"))
        XCTAssertFalse(websiteSource.contains(".browserContentViewportBackground("))
        XCTAssertTrue(websiteSource.contains("BrowserContentViewportCutoutBackground"))
        XCTAssertTrue(websiteSource.contains("toolbarChromeGradient"))
        XCTAssertTrue(websiteSource.contains("ZenWorkspaceThemeResolver.resolve"))
