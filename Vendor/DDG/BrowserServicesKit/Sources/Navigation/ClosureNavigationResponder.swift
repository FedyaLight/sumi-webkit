...
@MainActor
struct ClosureNavigationResponder: NavigationResponder {
    ...
    init(decidePolicy: ((_: NavigationAction, _: inout NavigationPreferences) async -> NavigationActionPolicy?)? = nil,
