...
enum SidebarPassiveScrollIndicatorLayout {
    static let thumbWidth = OverlayScrollIndicatorStyle.thumbWidth
    static let expandedThumbWidth = OverlayScrollIndicatorStyle.expandedThumbWidth
    static let trackWidth = OverlayScrollIndicatorStyle.trackWidth
    static let thumbOpacity = OverlayScrollIndicatorStyle.thumbOpacity
    static let minimumThumbHeight = OverlayScrollIndicatorStyle.minimumThumbHeight
    static let thumbLayoutAnimationDuration = OverlayScrollIndicatorStyle.thumbLayoutAnimationDuration
    static let visibleDuration = OverlayScrollIndicatorStyle.visibleDuration
    static let fadeDuration = OverlayScrollIndicatorStyle.fadeDuration
