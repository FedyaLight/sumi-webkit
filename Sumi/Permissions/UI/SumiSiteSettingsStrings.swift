...
enum SumiSiteSettingsStrings {
    ...
    static let subtitle = "Control what sites can use, such as camera, microphone, location, notifications, pop-ups, and autoplay. Saved decisions apply across regular profiles."
    ...
    static let viewSitesSubtitle = "Review saved permissions shared by regular profiles. Website data is shown for the current profile."
    ...
    static let siteListEmpty = "No saved site permissions."
    static let categoryExceptionsEmpty = "No site exceptions for this permission."
    static let resetPermissions = "Reset permissions"
    static let resetPermissionsSubtitle = "Clears saved permission decisions for this site in every regular profile. Cookies and site data are not cleared."
    ...
    static func permissionScope(isEphemeralProfile: Bool) -> String {
        isEphemeralProfile
            ? "Private-window permissions are temporary."
            : "Saved permissions are shared across regular profiles."
    }

    static func resetPermissionsSubtitle(isEphemeralProfile: Bool) -> String {
        isEphemeralProfile
            ? "Clears this private window's temporary permission decisions."
            : resetPermissionsSubtitle
    }
}
