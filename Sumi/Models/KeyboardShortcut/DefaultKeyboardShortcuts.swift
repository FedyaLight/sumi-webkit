...
enum DefaultKeyboardShortcuts {
    static let shortcuts: [KeyboardShortcut] = [
        ...
        KeyboardShortcut(action: .splitGrid, keyCombination: KeyCombination(key: "g", modifiers: [.command, .option])),
        KeyboardShortcut(action: .splitVertical, keyCombination: KeyCombination(key: "v", modifiers: [.command, .option])),
        KeyboardShortcut(action: .splitHorizontal, keyCombination: KeyCombination(key: "h", modifiers: [.command, .option])),
        KeyboardShortcut(action: .unsplit, keyCombination: KeyCombination(key: "u", modifiers: [.command, .option])),
        KeyboardShortcut(action: .newEmptySplit, keyCombination: KeyCombination(key: "g", modifiers: [.command, .shift, .option])),
