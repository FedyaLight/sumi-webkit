...
enum DefaultKeyboardShortcuts {
    static let shortcuts: [KeyboardShortcut] = [
        ...
        KeyboardShortcut(action: .duplicateTab, keyCombination: nil),
        ...
        KeyboardShortcut(action: .splitHorizontal, keyCombination: nil),
        ...
        KeyboardShortcut(action: .goToSpace9, keyCombination: KeyCombination(key: "9", modifiers: [.control])),
        KeyboardShortcut(action: .goToSpace10, keyCombination: KeyCombination(key: "0", modifiers: [.control])),
        KeyboardShortcut(action: .newWindow, keyCombination: KeyCombination(key: "n", modifiers: [.command])),
        KeyboardShortcut(action: .newPrivateWindow, keyCombination: KeyCombination(key: "n", modifiers: [.command, .shift])),
        KeyboardShortcut(action: .closeWindow, keyCombination: KeyCombination(key: "w", modifiers: [.command, .shift])),
        KeyboardShortcut(action: .closeBrowser, keyCombination: nil),
        KeyboardShortcut(action: .toggleFullScreen, keyCombination: nil),
        ...
        KeyboardShortcut(action: .openSettings, keyCombination: nil),
        ...
        KeyboardShortcut(action: .customizeSpaceGradient, keyCombination: nil),
    ]
