...
internal class FireproofDomains: DomainFireproofStatusProviding {
    ...
    private enum DefaultsKey {
        ...
        static let migratedToETLDPlus1 = "sumi.fireproof.areDomainsMigratedToETLDPlus1"
    }

    private var legacyUserDefaultsFireproofDomains: [String]? {
        get { defaults.stringArray(forKey: DefaultsKey.legacyDomains) }
        set { defaults.set(newValue, forKey: DefaultsKey.legacyDomains) }
    }

    private var areDomainsMigratedToETLDPlus1: Bool {
        get { defaults.bool(forKey: DefaultsKey.migratedToETLDPlus1) }
        set { defaults.set(newValue, forKey: DefaultsKey.migratedToETLDPlus1) }
    }
    ...
    private func loadFireproofDomains() -> FireproofDomainsContainer {
        ...
        do {
            ...
            logger.error("FireproofDomainsStore: Failed to load Fireproof Domains")
