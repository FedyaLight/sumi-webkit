...
class BookmarkEntity: NSManagedObject {
    ...
    enum Constants {
        ...
        static let favoriteFoldersIDs: Set<String> = Set(FavoritesFolderID.allCases.map(\.rawValue))
    }
    ...
    @NSManaged var isStub: Bool
    @NSManaged var children: NSOrderedSet?
    @NSManaged fileprivate(set) var lastChildrenPayloadReceivedFromSync: String?
    @NSManaged fileprivate(set) var favoriteFolders: NSSet?
    @NSManaged fileprivate(set) var favorites: NSOrderedSet?
    @NSManaged var parent: BookmarkEntity?

    @NSManaged fileprivate(set) var isPendingDeletion: Bool
    ...
    var shouldManageModifiedAt: Bool = true
    ...
    static func makeBookmark(title: String,
                                    url: String,
                                    parent: BookmarkEntity,
                                    insertAtBeginning: Bool = false,
                                    context: NSManagedObjectContext) -> BookmarkEntity {
...
extension BookmarkEntity {
    ...
    @NSManaged func insertIntoChildren(_ value: BookmarkEntity, at idx: Int)

    @objc(removeObjectFromChildrenAtIndex:)
    @NSManaged func removeFromChildren(at idx: Int)

    @objc(insertChildren:atIndexes:)
    @NSManaged func insertIntoChildren(_ values: [BookmarkEntity], at indexes: NSIndexSet)

    @objc(removeChildrenAtIndexes:)
    @NSManaged func removeFromChildren(at indexes: NSIndexSet)

    @objc(replaceObjectInChildrenAtIndex:withObject:)
    @NSManaged func replaceChildren(at idx: Int, with value: BookmarkEntity)

    @objc(replaceChildrenAtIndexes:withChildren:)
    @NSManaged func replaceChildren(at indexes: NSIndexSet, with values: [BookmarkEntity])

    @objc(addChildrenObject:)
    @NSManaged func addToChildren(_ value: BookmarkEntity)

    @objc(removeChildrenObject:)
    @NSManaged func removeFromChildren(_ value: BookmarkEntity)

    @objc(addChildren:)
    @NSManaged func addToChildren(_ values: NSOrderedSet)

    @objc(removeChildren:)
    @NSManaged func removeFromChildren(_ values: NSOrderedSet)
