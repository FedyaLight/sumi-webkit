...
enum BookmarkHTMLExporter {
    static func exportBookmarksHTML(root: BookmarkEntity) -> String {
        var lines: [String] = [
    ...
    static func exportBookmarksHTML(from context: NSManagedObjectContext) throws -> String {
    ...
    static func exportBookmarksHTML(from context: NSManagedObjectContext, to destination: URL) throws {
        do {
