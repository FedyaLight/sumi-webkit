...
class WindowRegistry {
    ...
    func register(_ window: BrowserWindowState) {
        ...
        RuntimeDiagnostics.emit("🪟 [WindowRegistry] Registered window: \(window.id)")
    }
    ...
    func unregister(_ id: UUID) {
        ...
        RuntimeDiagnostics.emit("🪟 [WindowRegistry] Unregistered window: \(id)")
    }
    ...
    func setActive(_ window: BrowserWindowState) {
        ...
        RuntimeDiagnostics.emit("🪟 [WindowRegistry] Active window: \(window.id)")
    }
