    ...
    var body: some View {
        GeometryReader { proxy in
            ...
            ZStack(alignment: .topLeading) {
                ...
                Rectangle()
                    .fill(Color.black.opacity(WorkspaceThemePickerOverlayChrome.scrimOpacity))
                    .frame(
                        width: layout.scrimFrame.width,
                        height: layout.scrimFrame.height
                    )
                    .offset(x: layout.scrimFrame.minX, y: layout.scrimFrame.minY)
                    .allowsHitTesting(false)
